...
public class TestNGAnnotationsTC1 extends ProjectSpecificMethod {
	
	
	@Test
	public void verfiyLegalEntity() throws InterruptedException {
		...
		String inputName = "Salesforce Automation by TestUser1";
		WebElement nameWE = driver.findElement(By.xpath("//input[@name='Name']"));
		driver.executeScript("arguments[0].value='Salesforce Automation by TestUser1';", nameWE);
